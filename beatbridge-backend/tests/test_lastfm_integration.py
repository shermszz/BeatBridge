...
class TestLastFMIntegration:
    """
    Comprehensive test suite for Last.fm API integration features:
    - Direct API integration testing
    - Genre listing and validation
    - Song recommendations with user customization
    ...
    def test_recommend_song_success(self, mock_get, test_client):
        """Test successful song recommendation with user customization"""
